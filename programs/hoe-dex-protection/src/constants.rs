...
pub const MAX_FEE_TIERS: usize = 100; // Maximum number of fee tiers
pub const MAX_BLACKLIST_SIZE: usize = 1000; // Maximum number of blacklisted traders
pub const BATCH_BLACKLIST_MAX_SIZE: usize = 50; // Maximum traders per batch blacklist
pub const MIN_FEE_TIER_SPACING_BPS: u64 = 10; // 0.1% minimum spacing between fee tiers
...
pub const MAX_TRADE_SIZE_LIMIT: u64 = 1000000; // Maximum trade size in token units
pub const MAX_HOURLY_TRADES_LIMIT: u32 = 100; // Maximum trades per hour
pub const MAX_HOURLY_VOLUME_LIMIT: u64 = 10000000; // Maximum hourly volume in token units
pub const MAX_DAILY_VOLUME_LIMIT: u64 = 100000000; // Maximum daily volume in token units
pub const MAX_PRICE_IMPACT_LIMIT: u64 = 1000; // 10% maximum price impact
pub const MAX_TRADE_SIZE_THRESHOLD: u64 = 1000000; // Maximum trade size in token units
pub const MAX_HOURLY_TRADES_THRESHOLD: u32 = 100; // Maximum trades per hour
pub const MAX_HOURLY_VOLUME_THRESHOLD: u64 = 10000000; // Maximum hourly volume in token units
pub const MAX_DAILY_VOLUME_THRESHOLD: u64 = 100000000; // Maximum daily volume in token units
pub const MAX_PRICE_IMPACT_THRESHOLD: u64 = 1000; // 10% maximum price impact
...
pub const MAX_TRADE_SIZE_DECAY_RATE: u64 = 100; // 1% decay per hour
pub const MAX_HOURLY_TRADES_DECAY_RATE: u64 = 100; // 1% decay per hour
pub const MAX_HOURLY_VOLUME_DECAY_RATE: u64 = 100; // 1% decay per hour
pub const MAX_DAILY_VOLUME_DECAY_RATE: u64 = 100; // 1% decay per hour
pub const MAX_PRICE_IMPACT_DECAY_RATE: u64 = 100; // 1% decay per hour
...
pub const MAX_TRADE_SIZE_DECAY_THRESHOLD: u64 = 1000000; // Maximum trade size in token units
pub const MAX_HOURLY_TRADES_DECAY_THRESHOLD: u32 = 100; // Maximum trades per hour
pub const MAX_HOURLY_VOLUME_DECAY_THRESHOLD: u64 = 10000000; // Maximum hourly volume in token units
pub const MAX_DAILY_VOLUME_DECAY_THRESHOLD: u64 = 100000000; // Maximum daily volume in token units
pub const MAX_PRICE_IMPACT_DECAY_THRESHOLD: u64 = 1000; // 10% maximum price impact
pub const MAX_TRADE_SIZE_DECAY_RATE_THRESHOLD: u64 = 100; // 1% decay per hour
pub const MAX_HOURLY_TRADES_DECAY_RATE_THRESHOLD: u64 = 100; // 1% decay per hour
pub const MAX_HOURLY_VOLUME_DECAY_RATE_THRESHOLD: u64 = 100; // 1% decay per hour
pub const MAX_DAILY_VOLUME_DECAY_RATE_THRESHOLD: u64 = 100; // 1% decay per hour
pub const MAX_PRICE_IMPACT_DECAY_RATE_THRESHOLD: u64 = 100; // 1% decay per hour
pub const MAX_TRADE_SIZE_DECAY_WINDOW_THRESHOLD: u64 = 3600; // 1 hour decay window
pub const MAX_HOURLY_TRADES_DECAY_WINDOW_THRESHOLD: u64 = 3600; // 1 hour decay window
pub const MAX_HOURLY_VOLUME_DECAY_WINDOW_THRESHOLD: u64 = 3600; // 1 hour decay window
pub const MAX_DAILY_VOLUME_DECAY_WINDOW_THRESHOLD: u64 = 86400; // 24 hour decay window
pub const MAX_PRICE_IMPACT_DECAY_WINDOW_THRESHOLD: u64 = 3600; // 1 hour decay window
pub const MAX_TRADE_SIZE_DECAY_RESET_THRESHOLD: u64 = 3600; // 1 hour decay reset
pub const MAX_HOURLY_TRADES_DECAY_RESET_THRESHOLD: u64 = 3600; // 1 hour decay reset
pub const MAX_HOURLY_VOLUME_DECAY_RESET_THRESHOLD: u64 = 3600; // 1 hour decay reset
pub const MAX_DAILY_VOLUME_DECAY_RESET_THRESHOLD: u64 = 86400; // 24 hour decay reset
pub const MAX_PRICE_IMPACT_DECAY_RESET_THRESHOLD: u64 = 3600; // 1 hour decay reset 